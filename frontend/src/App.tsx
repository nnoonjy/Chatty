...
function App() {
  ...
  return (
    <div className="App" style={{ maxWidth: '600px', margin: '0 auto', padding: '20px', fontFamily: 'sans-serif' }}>
      {/* 헤더 */}
      <div style={{ backgroundColor: '#00573D', color: 'white', padding: '15px', borderRadius: '8px 8px 0 0', textAlign: 'center' }}>
      ...
      <div style={{
        ...
        {isLoading && <div style={{ textAlign: 'center', color: '#888', fontSize: '0.9em' }}>답변 생성 중...</div>}
      </div>
